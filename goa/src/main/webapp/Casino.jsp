	...
	<form action="sent" method="get">
		...
		<div class="mb-3">
			<label for="exampleFormControlInput1" class="form-label">Cruise
				name</label> <input type="text" class="form-control" name="cruise"
		...
		<div class="form-check">
			<input type="radio"  class="form-check-input" id="radio2" name="freeFood"
				value="yes">free food :yes<label class="form-check-label"
				for="radio2"></label><br>
				<input type="radio"  class="form-check-input" id="radio2" name="freeFood"
				value="no">free food :no<label class="form-check-label"
				for="radio2"></label>
			<div>
