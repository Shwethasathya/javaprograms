...
Confirm Password<input name = "confirmPassword" id="confirmPassword" placeholder="reenter password" type="password" onblur="validPassword()"/><br><br>
...
function validPassword(){
	...
	var valid = document.getElementById('confirmPassword');
	var confirmPassword = document.getElementById('comparePassword');
	var confirmPasswordValue = confirmPassword.value;
	var comparePasswordValue = comparePassword.value;
	console.log(confirmPasswordValue);
	if (confirmPasswordValue != null && confirmPasswordValue != ""
			&& confirmPasswordValue.length > 8
			&& confirmPasswordValue.length < 12) {
		if (confirmPasswordValue == comparePasswordValue) {
